...
<head>
  ...
  <title>WideConnections Ae - Início</title>
...
<div class="container">
  ...
  <h5 class="text-center mt-3 mb-2">Sua Escola</h5>
    <div class="col-10 offset-1 pc">
      <div class="row">
        <hr>  
    <?php foreach($Noticia->listarnoticiasescola($_SESSION['id_usuario']) as $noticia){ ?>
      <div class="col-12 noticia">
        <div class="row mb-3 hd">
          ...
          <div class="col-7">
            <span>Em <a class="text-primary" href="<?php echo 'categoria.php?id='.$noticia->id_subcategoria; ?>"><?php echo $Noticia->mostrarsubcategoria($noticia->id_subcategoria)->subcategoria ?></a></span> - <?php echo '( '.$Escola->mostrar($noticia->id_escola)->escola.' )'; ?>  - <?php echo $Escola->mostrar($noticia->id_escola)->escola; ?>
            ...
            <p>
              ...
              <form action="?" method="get">
                ...
                <br><br><span class="autor">Escrita Por > <?php echo $Usuario->mostrar($noticia->id_usuario)->nome ?></span> <br> <span class="mensagem">(!) Essa Notícia não representa a visão do WideConnections, apenas do Autor Dela.</span>
              </form>
            </p>
          </div>
        </div>
  ...
  <h5 class="text-center mt-3 mb-2">Sua Cidade</h5>
    <div class="col-10 offset-1 pc">
      <div class="row">
        <hr>  
    <?php foreach($Noticia->listarnoticiascidade($_SESSION['id_usuario']) as $noticia){ ?>
      <div class="col-12 noticia">
        <div class="row mb-3 hd">
          <div class="col-6">
            <a <?php if($noticia->conteudo != ''){ echo 'href="../noticia.php?id='.$noticia->id_noticia.'"'; }else{ if($noticia->link != ''){ echo 'href="'.$noticia->link.'"target="_blank"'; } }?>><img src="../imagens/<?php echo $noticia->capa ?>" alt="capa da noticia"></a>
  ...
  <h5 class="text-center mt-3 mb-2">Seu Estado</h5>
    <div class="col-10 offset-1 pc">
      <div class="row">
        <hr> 
    <?php foreach($Noticia->listarnoticiasestado($_SESSION['id_usuario']) as $noticia){ ?>
      <div class="col-12 noticia">
        <div class="row mb-3 hd">
          <div class="col-6">
            <a <?php if($noticia->conteudo != ''){ echo 'href="../noticia.php?id='.$noticia->id_noticia.'"'; }else{ if($noticia->link != ''){ echo 'href="'.$noticia->link.'"target="_blank"'; } }?>><img src="../imagens/<?php echo $noticia->capa ?>" alt="capa da noticia"></a>
